...
const BREEDS = [
  ...
  { slug: "yorkshire-terrier", category: "dog", en: "Yorkshire Terrier", zh: "约克夏梗",
    features: "Yorkshire Terrier: long silky straight steel-blue and tan coat parting down the back, small toy build, erect V-shaped ears, bright dark eyes, confident terrier expression",
    deco: "paw prints and bones and leaves" },
  { slug: "maltese", category: "dog", en: "Maltese", zh: "马尔济斯犬",
    features: "Maltese: pure white long silky single-layer coat reaching the ground, small compact toy build, round dark eyes, drop ears covered in long hair, gentle expression",
    deco: "paw prints and bones and leaves" },
  { slug: "shih-tzu", category: "dog", en: "Shih Tzu", zh: "西施犬",
    features: "Shih Tzu: long flowing double coat in many colors, flat pushed-in face with short muzzle, large round dark eyes, drop ears heavily feathered, sturdy toy build, chrysanthemum face",
    deco: "paw prints and bones and leaves" },
  { slug: "scottish-fold", category: "cat", en: "Scottish Fold", zh: "苏格兰折耳猫",
    features: "Scottish Fold: distinctively folded forward and down ears, round head with big round eyes, dense plush coat in many colors, medium cobby build, owl-like expression",
    deco: "paw prints and fish bones and feathers" },
  { slug: "munchkin", category: "cat", en: "Munchkin", zh: "曼基康矮脚猫",
    features: "Munchkin: distinctly short legs due to genetic dwarfism, normal-sized body, all coat colors and patterns, walnut-shaped eyes, medium triangular ears, low-to-ground stance",
    deco: "paw prints and fish bones and feathers" },
  { slug: "sugar-glider", category: "small-mammal", en: "Sugar Glider", zh: "蜜袋鼯",
    features: "Sugar Glider: small marsupial with patagium (gliding membrane) from wrists to ankles, large dark eyes for nocturnal life, soft grey-brown fur with cream belly, long prehensile tail, pointed snout",
    deco: "small leaves and seeds" },
  { slug: "capybara", category: "small-mammal", en: "Capybara", zh: "水豚",
    features: "Capybara: world's largest rodent, barrel-shaped body with sparse coarse brown fur, blunt rounded snout, small round ears, webbed feet, semi-aquatic build, calm expression",
    deco: "small leaves and seeds" },
  { slug: "canary", category: "bird", en: "Canary", zh: "金丝雀",
    features: "Canary: small songbird with smooth compact body, short conical beak, predominantly yellow or orange plumage in wild type, multiple domesticated color varieties, melodious song in males",
    deco: "feathers and twigs" },
  { slug: "macaw", category: "bird", en: "Macaw", zh: "金刚鹦鹉",
    features: "Macaw: large parrot with long tapered tail, massive hooked beak, bare facial patch with fine feather lines, brilliant multi-color plumage in red/blue/yellow/green, powerful zygodactyl feet",
    deco: "feathers and twigs" },
  { slug: "corn-snake", category: "reptile", en: "Corn Snake", zh: "玉米蛇",
    features: "Corn Snake: slender non-venomous colubrid with orange-red base color and dark red saddle markings bordered in black, checkered belly pattern resembling corn kernels, smooth scales, alert round pupils",
    deco: "scales and stones" },

  // ===== 新增第二批 9 品种(到 70) =====
  { slug: "pug", category: "dog", en: "Pug", zh: "八哥犬",
    features: "Pug: short smooth fawn or black coat, very flat pushed-in face with deep wrinkles, large round prominent dark eyes, small drop ears, compact square muscular toy build, curled tail",
    deco: "paw prints and bones and leaves" },
  { slug: "beagle", category: "dog", en: "Beagle", zh: "比格犬",
    features: "Beagle: short dense tri-color black/tan/white or lemon coat, medium compact hound build, long soft drop ears, expressive hazel eyes, merry alert expression, white-tipped tail",
    deco: "paw prints and bones and leaves" },
  { slug: "boxer", category: "dog", en: "Boxer", zh: "拳师犬",
    features: "Boxer: short smooth fawn or brindle coat, square muscular medium build, flat pushed-in face with undershot jaw, dark brown eyes, natural or cropped ears, athletic powerful build",
    deco: "paw prints and bones and leaves" },
  { slug: "russian-blue", category: "cat", en: "Russian Blue", zh: "俄罗斯蓝猫",
    features: "Russian Blue: short dense plush double coat in uniform blue-grey, slender elegant foreign build, wedge-shaped head, large wide-set vivid green eyes, large pointed ears",
    deco: "paw prints and fish bones and feathers" },
  { slug: "bengal", category: "cat", en: "Bengal", zh: "孟加拉豹猫",
    features: "Bengal: short dense pelt-like coat with distinctive leopard rosette or marble markings in brown/silver/snow, muscular wild-looking medium build, small rounded ears, dark-rimmed eyes",
    deco: "paw prints and fish bones and feathers" },
  { slug: "prairie-dog", category: "small-mammal", en: "Black-tailed Prairie Dog", zh: "黑尾土拨鼠",
    features: "Prairie Dog: small ground squirrel with short tan-brown fur, distinctive black-tipped tail, alert small rounded ears, black eyes, sharp claws for digging, chubby compact body",
    deco: "small leaves and seeds" },
  { slug: "tenrec", category: "small-mammal", en: "Lesser Hedgehog Tenrec", zh: "马岛猬",
    features: "Tenrec: small Madagascar mammal resembling a tiny hedgehog, sharp spines on back and head, soft fur on belly, pointed snout with small black eyes, small rounded ears",
    deco: "small leaves and seeds" },
  { slug: "zebra-finch", category: "bird", en: "Zebra Finch", zh: "斑胸草雀",
    features: "Zebra Finch: tiny songbird with grey plumage, distinctive black-and-white zebra-striped throat pattern in males, bright orange-red beak, orange cheeks, plump rounded body",
    deco: "feathers and twigs" },
  { slug: "axolotl", category: "reptile", en: "Axolotl", zh: "墨西哥钝口螈",
    features: "Axolotl: aquatic salamander with smooth skin, six feathery external gills on each side of head, four short legs, long flat tail, pale pink/white albino or wild-type dark coloration",
    deco: "scales and stones" },

  // ===== C 批 1+2+3 新增 30 品种(到 100) =====
  { slug: "basset-hound", category: "dog", en: "Basset Hound", zh: "巴吉度",
    features: "Basset Hound: short smooth tri-color or red-white coat, very short legs, extremely long droopy ears reaching past muzzle, sad droopy face with loose wrinkled skin, large heavy bone structure for short stature",
    deco: "paw prints and bones and leaves" },
  { slug: "jack-russell-terrier", category: "dog", en: "Jack Russell Terrier", zh: "杰克罗素梗",
    features: "Jack Russell Terrier: predominantly white smooth or broken coat with black/tan markings, compact athletic small build, V-shaped drop ears, dark almond eyes, alert intense expression, docked or natural tail",
    deco: "paw prints and bones and leaves" },
  { slug: "english-springer-spaniel", category: "dog", en: "English Springer Spaniel", zh: "英国史宾格猎犬",
    features: "English Springer Spaniel: medium-length liver and white or black and white coat with feathering, medium sturdy build, long drop ears, gentle soft expression, kind eyes, deep chest",
    deco: "paw prints and bones and leaves" },
  { slug: "old-english-sheepdog", category: "dog", en: "Old English Sheepdog", zh: "古代英国牧羊犬",
    features: "Old English Sheepdog: profuse shaggy grey and white double coat covering the entire body and eyes, large square muscular build, bobbed or natural short tail, deep bark, bear-like shambling gait",
    deco: "paw prints and bones and leaves" },
  { slug: "burmese", category: "cat", en: "Burmese", zh: "缅甸猫",
    features: "Burmese: short satiny dark brown sable coat with golden eyes, compact muscular medium build, round head with short muzzle, large round expressive eyes, silky close-lying coat, friendly dog-like personality",
    deco: "paw prints and fish bones and feathers" },
  { slug: "bombay", category: "cat", en: "Bombay", zh: "孟买猫",
    features: "Bombay: short jet-black glossy patent-leather coat, copper-gold round eyes, sleek muscular medium build, rounded head with short muzzle, panther-like miniature appearance",
    deco: "paw prints and fish bones and feathers" },
  { slug: "american-curl", category: "cat", en: "American Curl", zh: "美国卷耳猫",
    features: "American Curl: distinctively curled-back ears (90-180 degrees), silky semi-long or short coat in many colors, medium wedge-shaped head, large walnut-shaped eyes, gentle alert expression",
    deco: "paw prints and fish bones and feathers" },
  { slug: "gerbil", category: "small-mammal", en: "Mongolian Gerbil", zh: "蒙古沙鼠",
    features: "Mongolian Gerbil: small sandy-brown agouti coat with white belly, long tufted tail, large dark eyes, small rounded ears, long hind legs for jumping, plump body",
    deco: "small leaves and seeds" },
  { slug: "degu", category: "small-mammal", en: "Degu", zh: "八齿鼠",
    features: "Degu: small rodent with brownish-grey coat and lighter belly, distinctive eight-shaped molars, large dark eyes, rounded ears, long thin tail with tufted tip, chunky compact build",
    deco: "small leaves and seeds" },
  { slug: "sun-conure", category: "bird", en: "Sun Conure", zh: "太阳锥尾鹦鹉",
    features: "Sun Conure: small to medium parrot with brilliant orange-yellow plumage, green-blue flight feathers, white eye-rings, black hooked beak, long tapered tail, lively social personality",
    deco: "feathers and twigs" },
  { slug: "havanese", category: "dog", en: "Havanese", zh: "哈瓦那犬",
    features: "Havanese: long silky wavy double coat in many colors, small compact toy build, dark almond eyes, drop ears covered in long hair, plumed tail carried over back, friendly bouncy gait",
    deco: "paw prints and bones and leaves" },
  { slug: "dalmatian", category: "dog", en: "Dalmatian", zh: "大麦町犬",
    features: "Dalmatian: short glossy white coat with distinctive black or liver spots, athletic medium build, drop ears, alert intelligent expression, deep chest, tapered tail",
    deco: "paw prints and bones and leaves" },
  { slug: "turkish-angora", category: "cat", en: "Turkish Angora", zh: "土耳其安哥拉猫",
    features: "Turkish Angora: long silky single-layer flowing coat without undercoat, slender elegant medium build, wedge-shaped head, large pointed ears, almond-shaped blue/green/gold eyes, plumed tail",
    deco: "paw prints and fish bones and feathers" },
  { slug: "somali", category: "cat", en: "Somali", zh: "索马里猫",
    features: "Somali: long fox-like ticked ruddy/red coat, bushy fox-like tail, almond-shaped gold/green eyes, large pointed ears, agile muscular medium build, mischievous playful expression",
    deco: "paw prints and fish bones and feathers" },
  { slug: "society-finch", category: "bird", en: "Society Finch", zh: "禾雀",
    features: "Society Finch: small songbird with grey-brown back and distinctive white belly, black mask, conical pink/silver beak, plump rounded body, social flocking nature",
    deco: "feathers and twigs" },
  { slug: "java-sparrow", category: "bird", en: "Java Sparrow", zh: "爪哇禾雀",
    features: "Java Sparrow: medium songbird with plump grey body, distinctive red-pink ring around eye, large thick pink-red beak, white cheek patches, black head, short tail",
    deco: "feathers and twigs" },
  { slug: "parrotlet", category: "bird", en: "Parrotlet", zh: "小鹦鹉",
    features: "Parrotlet: tiny chunky parrot with stocky build, predominantly green plumage with blue markings, short rounded tail, large dark eyes, hooked beak, miniature Amazon-like appearance",
    deco: "feathers and twigs" },
  { slug: "red-footed-tortoise", category: "reptile", en: "Red-footed Tortoise", zh: "红腿陆龟",
    features: "Red-footed Tortoise: domed black shell with yellow center on each scute, distinctive red-orange patches on legs and head, medium compact build, slight plastron concave in males, calm expression",
    deco: "scales and stones" },
  { slug: "blue-tongued-skink", category: "reptile", en: "Blue-tongued Skink", zh: "蓝舌石龙子",
    features: "Blue-tongued Skink: large robust lizard with smooth banded silver-grey and tan scales, distinctive cobalt-blue tongue, short stumpy legs, triangular head, fat segmented tail, calm demeanor",
    deco: "scales and stones" },
  { slug: "hermann-tortoise", category: "reptile", en: "Hermann's Tortoise", zh: "赫曼陆龟",
    features: "Hermann's Tortoise: domed yellow and black shell with distinctive divided supracaudal scute, scaly stumpy yellow-tan legs, hooked upper beak, small head with dark eyes, short keratinous tail tip",
    deco: "scales and stones" },
  { slug: "doberman-pinscher", category: "dog", en: "Doberman Pinscher", zh: "杜宾犬",
    features: "Doberman Pinscher: short smooth black/red/blue coat with rust markings, sleek athletic muscular medium-large build, long wedge-shaped head, cropped or natural pointed ears, docked tail, alert regal stance",
    deco: "paw prints and bones and leaves" },
  { slug: "rottweiler", category: "dog", en: "Rottweiler", zh: "罗威纳犬",
    features: "Rottweiler: short coarse black coat with distinctive rust-tan markings on cheeks/chest/legs, powerful muscular large build, broad blocky head, drop ears, powerful jaw, calm confident demeanor",
    deco: "paw prints and bones and leaves" },
  { slug: "norwegian-forest-cat", category: "cat", en: "Norwegian Forest Cat", zh: "挪威森林猫",
    features: "Norwegian Forest Cat: long thick waterproof double coat with mane-like collar, large sturdy muscular build, triangular head, large tufted ears, long bushy tail, almond-shaped green/gold eyes, lynx-like appearance",
    deco: "paw prints and fish bones and feathers" },
  { slug: "birman", category: "cat", en: "Birman", zh: "伯曼猫",
    features: "Birman: semi-long silky color-point coat in seal/blue/chocolate, distinctive white symmetrical gloves on all four paws, deep blue round eyes, sturdy medium build, roman nose, gentle expression",
    deco: "paw prints and fish bones and feathers" },
  { slug: "chipmunk", category: "small-mammal", en: "Chipmunk", zh: "花栗鼠",
    features: "Chipmunk: tiny squirrel-like rodent with reddish-brown back and 5 distinctive black-and-white stripes, white belly, large cheek pouches for food storage, bushy tail, bright alert eyes",
    deco: "small leaves and seeds" },
  { slug: "indian-ringneck", category: "bird", en: "Indian Ringneck Parakeet", zh: "红领绿鹦鹉",
    features: "Indian Ringneck Parakeet: medium parrot with vibrant green plumage, distinctive black and pink neck ring in males, long tapered tail, hooked red beak, slender elegant build, intelligent eyes",
    deco: "feathers and twigs" },
  { slug: "gouldian-finch", category: "bird", en: "Gouldian Finch", zh: "七彩文鸟",
    features: "Gouldian Finch: small songbird with multi-colored rainbow plumage, red/black/yellow head variants, purple chest, yellow belly, turquoise blue nape, considered world's most colorful finch",
    deco: "feathers and twigs" },
  { slug: "quaker-parrot", category: "bird", en: "Quaker Parrot", zh: "和尚鹦鹉",
    features: "Quaker Parrot: medium small parrot with grey-green plumage, grey forehead and chest, blue-tinted flight feathers, long tapered tail, distinctive quaker hood appearance, stocky build",
    deco: "feathers and twigs" },
  { slug: "savannah-monitor", category: "reptile", en: "Savannah Monitor", zh: "草原巨蜥",
    features: "Savannah Monitor: large robust lizard with grey-brown base color and yellowish circular spots, muscular stocky build, powerful limbs with strong claws, broad triangular head, long muscular tail, active intelligent demeanor",
    deco: "scales and stones" },
  { slug: "gopher-snake", category: "reptile", en: "Gopher Snake", zh: "牛蛇",
    features: "Gopher Snake: medium non-venomous colubrid with yellow-tan base color and distinctive dark brown saddle markings, slender muscular build, small triangular head, round pupils, mimics rattlesnake behavior when threatened",
    deco: "scales and stones" },
];
